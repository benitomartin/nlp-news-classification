...
def main():
    ...
    model = tf.saved_model.load('C:/Users/bmart/OneDrive/15_NLP/nlp-news-classification/model')  # Replace 'your_model_directory' with the actual directory containing your SavedModel
